...
<head>
    ...
    <link rel="stylesheet" href="userLS.css">
</head>
        ...
        <div class="box">
            <div class="inner-box">
                <div class="forms-wrap">
                    <form action="functions/authcode.php" autocomplete="off" class="sign-in-form" method="post">
                        <div class="logo">
                            <img src="./img/logo2.png" alt="Main Logo" class="main-logo">
                            <img src="./img/logo1.png" alt="Overlay Logo" class="overlay-logo">
                            <h4> S-TEAM </h4>
                        </div>
                        ...
                        <div class="actual-form">
                            ...
                            <input name="login_btn" type="submit" value="Login" class="sign-btn" style="margin-top: 30px;"/>
                            <a href="#" class="g-toggle">
                    ...
                    <form action="functions/authcode.php" method="post" autocomplete="off" class="sign-up-form">
                        <div class="logo">
                            <img src="./img/logo2.png" alt="Main Logo" class="main-logo">
                            <img src="./img/logo1.png" alt="Overlay Logo" class="overlay-logo">
                            <h4> S-TEAM </h4>
                        ...
                        <div class="actual-form">
                            ...
                            <div class="input-wrap">
                                <input class="input-field" name="phone" type="number" autocomplete="off" required />
                                <label> Phone </label>
                            </div>
                            ...
                            <div class="input-wrap">
                                <input type="password" name="cpassword" minlength="4" class="input-field" autocomplete="off" required />
                                <label> Confirm Password </label>
                            </div>

                            <input type="submit" value="Sign Up" class="sign-btn" name="register_btn"/>
                            ...
                            <div class="login-container">
                                ...
                                <a href="#" class="g-toggle">
                                    <div class="login-text">
                                        <span href="#">Sign in with Google</span>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="carousel">
                    <div class="image-container">
                        <img src="./img/logo2.png" alt="Main Image" class="main-image">
